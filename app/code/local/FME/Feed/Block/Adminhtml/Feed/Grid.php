...
class FME_Feed_Block_Adminhtml_Feed_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
...
Mage::getModel('feed/feed')->getRss();
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('title', array(
          'header'    => Mage::helper('feed')->__('Title'),
          'align'     =>'left',
          'index'     => 'title',
      ));
      ...
      $this->addColumn('content', array(
			'header'    => Mage::helper('feed')->__('Item Content'),
			'width'     => '150px',
			'index'     => 'content',
      ));
	  */
      ...
      $this->addColumn('status', array(
        ...
        $this->addColumn('action',
            array(
                ...
                'actions'   => array(
                    array(
                        'caption'   => Mage::helper('feed')->__('Edit'),
                        'url'       => array('base'=> '*/*/edit'),
                        'field'     => 'id'
                    )
                ),
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('delete', array(
             'label'    => Mage::helper('feed')->__('Delete'),
             'url'      => $this->getUrl('*/*/massDelete'),
             'confirm'  => Mage::helper('feed')->__('Are you sure?')
        ));

        $statuses = Mage::getSingleton('feed/status')->getOptionArray();

        array_unshift($statuses, array('label'=>'', 'value'=>''));
        $this->getMassactionBlock()->addItem('status', array(
             'label'=> Mage::helper('feed')->__('Change status'),
