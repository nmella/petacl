...
class Moogento_Pickpack_Model_Source_Billingposition
{
    ...
    public function toOptionArray() {
        return array(
            ...
            array('value' => '2', 'label' => Mage::helper('pickpack')->__('Alternate, billing down, shipping up')),
        );
    }
