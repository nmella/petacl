...
class Moogento_Pickpack_Model_Source_Giftmessage
{
    ...
    public function toOptionArray() {
        return array(
            ...
            array('value' => 'yesbox', 'label' => Mage::helper('pickpack')->__('Yes, in movable box (handy for tear-off labels)')),
