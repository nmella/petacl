...
class Moogento_Pickpack_Model_Sales_Order_Processor_OrderPick2
    extends Moogento_Pickpack_Model_Sales_Order_Processor_Abstract2
{
    protected $_configGroupPrefix = 'picks';
    protected $_hiddenOrderFlag = 'pp_order_pick_list_printed';
	protected $_flagColumn = 'separate';
