...
class Moogento_Pickpack_Block_Adminhtml_System_Config_Form_Field_Shippingbackground_Shippingmethod
    ...
    public function _getTableHtml($element) {
        ...
        $html .= '<thead>';
            $html .= '<tr class="headings">';
                ...
                $html .= '<th>Pattern <span class="required">*</span></th>';
                $html .= '<th>X-Nudge</th>';
                $html .= '<th>Y-Nudge</th>';
                $html .= '<th>Priority</th>';
                $html .= '<th>Image</th>';
        ...
        if ($element->getValue()) {
            ...
            if (is_array($value)) {
                foreach($value as $rowId => $row_value) {
                    if ($row_value['file']) {
                        $value[$rowId]['image'] = "Current Image: <img src='".Mage::getBaseUrl('media').'moogento/pickpack/wonder_invoice/'.$row_value['file']."'><br>";
                    } else {
                        $value[$rowId]['image'] = '';
                    }
                }
