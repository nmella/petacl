...
class Moogento_Pickpack_Block_Subtotalorder extends Moogento_Pickpack_Block_Adminhtml_System_Config_Form_Field
{
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element) {
        ...
        */
        ...
        $output .= '<br /><p style = "font-size:90%;">&nbsp;' . Mage::helper('adminhtml')->__('Subtotal') . '&nbsp;&nbsp;&nbsp;' . Mage::helper('adminhtml')->__('Discounts') . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . Mage::helper('adminhtml')->__('Shipping'); //.'&nbsp;&nbsp; '.Mage::helper('adminhtml')->__('1st').' : ';
        $output .= '</p>';
