...
class Moogento_Pickpack_Block_Shippingpad extends Mage_Adminhtml_Block_System_Config_Form_Field
{
...
//         $order_3 = $element->setValue(isset($values[2]) ? $values[2] : null)->getElementHtml();
        ...
        $output = '&nbsp;&nbsp;' . $order_1 . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $order_2; //.'  &nbsp; '.$order_4;
        $output .= '<br /><p style = "font-size:90%;">&nbsp;' . Mage::helper('adminhtml')->__('Top, pt')  . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . Mage::helper('adminhtml')->__('Left, pt'); //.'&nbsp;&nbsp; '.Mage::helper('adminhtml')->__('1st').' : ';
        $output .= '</p>';
