...
class Moogento_Pickpack_Block_Time extends Moogento_Pickpack_Block_Adminhtml_System_Config_Form_Field
{
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element) {
        ...
        $html.= '<select name="'. $element->getName() . '" '.$element->serialize($element->getHtmlAttributes()).' style="width:40px;display:none;">'."\n";
        for( $i=0;$i<60;$i++ ) {
            $hour = str_pad($i, 2, '0', STR_PAD_LEFT);
