...
class Mage_Adminhtml_Model_Sales_Order_Create extends Varien_Object implements Mage_Checkout_Model_Cart_Interface
{
    ...
    public function importPostData($data)
    {
		...
		if (isset($data['custom_field']['field_1'])) {
		 $this->getQuote()->setData('field_1',$data['custom_field']['field_1']);
		}
		if (isset($data['custom_field']['field_2'])) {
		 $this->getQuote()->setData('field_2',$data['custom_field']['field_2']);
		}
		if (isset($data['custom_field']['field_3'])) {
		 $this->getQuote()->setData('field_3',$data['custom_field']['field_3']);
		}
		
		if (isset($data['custom_field']['field_4'])) {
		 $this->getQuote()->setData('field_4',$data['custom_field']['field_4']);
		}
		if (isset($data['custom_field']['field_5'])) {
		 $this->getQuote()->setData('field_5',$data['custom_field']['field_5']);
		}
		if (isset($data['custom_field']['field_6'])) {
		 $this->getQuote()->setData('field_6',$data['custom_field']['field_6']);
		}
