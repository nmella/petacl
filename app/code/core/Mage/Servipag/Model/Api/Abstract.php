...
abstract class Mage_Servipag_Model_Api_Abstract extends Varien_Object{
...
//const REFUND_TYPE_PARTIAL = 'Partial';
 ...
 public function getConfigData($key, $default=false){
  if (!$this->hasData($key)) {
   $value = Mage::getStoreConfig('Servipag/wpp/'.$key);
 ...
 public function getApiErrorUrl(){
  return Mage::getUrl($this->getConfigData('api_error_url', 'Servipag/express/error'));
 }

 public function getReturnUrl(){
  return Mage::getUrl($this->getConfigData('api_return_url', 'Servipag/express/return'));
 }

 public function getCancelUrl(){
  return Mage::getUrl($this->getConfigData('api_cancel_url', 'Servipag/express/cancel'));
 }
