        jQuery(document).ready(function(){
                ...
                jQuery("#field_1,#billing\\:taxvat, #billing\\:vat_id, #taxvat").focusin(function(){
                    if(jQuery(this).val()!='')
                        jQuery(this).val(deslash(jQuery(this).val()));
                });
                jQuery("#field_1,#billing\\:taxvat, #taxvat").focusout(function(){
                    if(jQuery(this).val()!='')
                        jQuery(this).val(slash(jQuery(this).val()));
                });

                jQuery("#field_1,#billing\\:taxvat, #billing\\:vat_id, #taxvat").addClass('rut');

                //jQuery("#field_1,#billing\\:taxvat, #taxvat").priceFormat();

                jQuery("#field_1, #billing\\:vat_id, #taxvat").change(function(){
                ...
                jQuery("#billing\\:taxvat, #billing\\:vat_id,").change(function(){
                    if(ComparaDV(jQuery(this).val())==true)
                    {
